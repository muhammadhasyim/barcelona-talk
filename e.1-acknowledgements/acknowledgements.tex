...
\begin{figure}
    \centering\includegraphics[height=0.55\textheight]{2.a-intro_dftheory/DF_Theory_Excitations_Zoom_2.pdf}
    \hspace{1em}
    \centering\includegraphics[height=0.55\textheight]{3.c-fac_results/persistlowT3.png}
