...
\centering\includegraphics[height=0.675\textheight]{7.d-kt_results/new-mechanism-0.pdf}\caption{Melting transition is a \textbf{critical point} $\to$ naive calculations of $Y^\mathrm{R}$ fails (divergent)!}
\end{figure}
