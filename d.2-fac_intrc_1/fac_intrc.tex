...
\begin{enumerate}
    ...
    \end{gather*}
    \only<3>{
    \centering\includegraphics[width=0.5\linewidth]{d.2-fac_intrc_1/excconfig2.pdf}
    }
    \only<4>{
    \centering\includegraphics[width=0.6\linewidth]{d.4-fac_results_1/minima.pdf}
    }
    ...
    \onslide<6->{
    \begin{equation*}
    \Delta F_{\alpha \alpha^\prime}^\ddagger = \Delta F_{\alpha^\prime \alpha}^\ddagger \only<5->{\  \centering\includegraphics[valign=c,width=0.425\linewidth]{d.2-fac_intrc_1/pes.pdf}}
    \end{equation*}
    }
    %\begin{figure}
